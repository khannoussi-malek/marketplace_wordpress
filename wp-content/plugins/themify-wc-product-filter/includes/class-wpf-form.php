                    ...
                    <div class="wpf_back_active_module_input">
                        <div class="wpf_custom_select wpf_order wpf_changed">
                            <select name="[<?php echo $type ?>][order]">
                                <?php foreach ($order as $k => $v): if('term_order'===$k && !in_array($type,array('wpf_cat','wpf_tag'))) continue; ?>
            ...
            case 'price':
                ...
                if ($price_type === 'slider') {
					...
					<div class="wpf-slider-label">
						<?php echo str_replace( '0', '<span class="wpf-price-min">' . ( empty( $from ) ? $min : $from ) . '</span>', WPF_Utils::format_price( 0 ) ); ?>
						-
						<?php echo str_replace( '0', '<span class="wpf-price-max">' . ( empty( $to ) ? $max : $to ) . '</span>', WPF_Utils::format_price( 0 ) ); ?>
					</div>
