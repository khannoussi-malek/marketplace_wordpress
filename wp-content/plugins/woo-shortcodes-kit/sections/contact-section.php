...
<div class="last wshk-tab" id="div-wshk-contact">
   ...
   <div style="background-color: white; width: 100%; padding: 20px 20px 20px 20px;border: 1px solid white; border-radius: 13px;">
    ...
    <h2 class="wshkinfoboxtitle"><span style="color:#a46497; font-size: 26px;"><span class="dashicons dashicons-info"></span> <?php esc_html_e( 'Help & Support!', 'woo-shortcodes-kit' ); ?></span></h2>
    <h4 class="wshkinfoboxdesc"><small><span style="color: #808080; font-size: 15px;padding-left: 30px;"><?php esc_html_e( 'Know more about Woo Shortcodes kit and how modding your WooCommerce shop!', 'woo-shortcodes-kit' ); ?></span></small><br /><small></h4>
...
.container {
  ...
  .mitem {
   ...
   <div class="wrapper">
    ...
    <br><center>
    <a class="wshksubscribenowbtncontact" href="http://bit.ly/wshknews" style="margin-bottom:30px;text-align:center;border-radius:13px;padding:10px;background-color:#a46497;color:white;font-size:14px;text-transfrom:uppercase;text-decoration:none;" target="_blank"><?php esc_html_e( 'SUBSCRIBE NOW', 'woo-shortcodes-kit' ); ?></a></center>
    <br>
    </div>
...
<center><img src="<?php echo  plugins_url( 'images/play-button.png', __DIR__ );?>" width="64" height="64" /></center>
