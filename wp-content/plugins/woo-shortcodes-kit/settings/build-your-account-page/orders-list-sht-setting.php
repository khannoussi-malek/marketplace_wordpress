...
<table class="funcordersteptwo" width="50%">
    ...
    <td style="width: 35%;">
        ...
        <br>
    <div style="padding-left:30px;"><p> <?php esc_html_e( 'Number of orders', 'woo-shortcodes-kit' ); ?><br /> <input class="testininputclass" type="number" id="wshk_numeropedidosnew" name="wshk_numeropedidosnew"  value="<?php if(get_option('wshk_numeropedidosnew')!=''){ echo get_option('wshk_numeropedidosnew'); }?>" placeholder="15"/ size="10" ></p>     
